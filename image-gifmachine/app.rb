...
configure do
  ...
  set :gifmachine_fallback_gif, 'https://sentralservers.files.wordpress.com/2016/08/watching-the-console-whilst-rebooting-a-server-at-3am.gif'
end
...
def get_most_recent_gif_json
  ...
  if gif && gif.first
  ...
  else
    {
        ...
        :meme_top => 'take your time to review it',
        :meme_bottom => 'I am fine'
    }.to_json
  end
end
